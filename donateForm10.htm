...
<link href="Content/Css/HostedDonation.css" rel="stylesheet" type="text/css">

<head>
<title>Donate to Extollo International</title>
<link href="https://extolloint.github.io/bloomerang/HostedDonation.css" rel="stylesheet" type="text/css">
</head>
...
<!--OPTIONAL: Add default attribute of checked="true" after the radio button of desired default selected amount same with the checkbox for monthly donations.

<!--PASTE code from Bloomerang below this comment-->
<script type="text/javascript" id="bloomerangForm22137856"></script>
<pre><script type="text/javascript">
    var insertForm22137856 = function() {
        var html22137856 = '<style text=\'text/css\'>' + 
...
'      <h3>Donation</h3>' + 
'      <div class="field radio 22150144 required" >' + 
'<label for="22150144"><input id="22150144" name="donation-level" class="required" type="radio" value="5.000000" maxlength="255"></input><span class="label">$5.00 - Equivalent of $0.17 cents per day</span></label>' + 
'</div>' + 
'<div class="field radio 22145024 required" >' + 
'<label for="22145024"><input id="22145024" name="donation-level" class="required" type="radio" checked="true" value="10.000000" maxlength="255"></input><span class="label">$10.00 - Equivalent of $0.33 cents per day</span></label>' + 
'</div>' + 
'<div class="field radio 22150145 required" >' + 
'<label for="22150145"><input id="22150145" name="donation-level" class="required" type="radio" value="25.000000" maxlength="255"></input><span class="label">$25.00 - Equivalent of $0.83 cents per day</span></label>' + 
'</div>' + 
'<div class="field radio 22150146 required" >' + 
'<label for="22150146"><input id="22150146" name="donation-level" class="required" type="radio" value="50.000000" maxlength="255"></input><span class="label">$50.00 - Equivalent of $1.66 cents per day</span></label>' + 
'</div>' + 
'<div class="field radio 22150147 required" >' + 
'<label for="22150147"><input id="22150147" name="donation-level" class="required" type="radio" value="100.000000" maxlength="255"></input><span class="label">$100.00 - Equivalent of $3.33 cents per day</span></label>' + 
'</div>' + 
...
'<label for="recurring"><input id="recurring" name="recurring" type="checkbox" checked="true" maxlength="255"></input><span class="label">Show my support by making this a monthly donation</span></label>' + 
'</div>' + 
'' + 
'</div>' + 
'    ' + 
...
'<label for="consent-all"><input id="consent-all" name="consent-all" type="checkbox" maxlength="255"></input><span class="label">I would like to receive or continue receiving updates from Extollo International</span></label>' + 
'</div>' + 
...
'      <label id=\'noCaptchaResponseError\' class=\'error noCaptchaResponseError\' style=\'display: none\'>You must fill out the CAPTCHA</label><div id="captcha22137856"></div>' + 
'' + 
'</div>' + 
'    <div class="btn-group">' + 
...
'</div>' + 
'' + 
'' +  '';var successHtml22137856 = '\u003cscript\u003ewindow.location.replace(\'https://www.extollointernational.org/donate-success\')\u003c/script\u003e';( function($) {if (Bloomerang.useDonationId('22137856')) { 
                                    Bloomerang.useProcessor('566272', 'Spreedly', 'OqOMv1ksjPtXEYHtCYsVXzEpCbR');
                                } else {
                                    html22137856 = '<p style="color: red">Only one donation or event registration form can be used on each page.</p>';
                                }if (jQuery('#bloomerangForm22137856').length) {
                        
                    if (window.ActiveXObject) { // they are using IE < 11, which doesn't support TLS 1.1
                        html22137856 = '<p style="color: red">​Your browser does not support the minimum security requirements for keeping your Credit Card information safe when processing payments. Please upgrade ​your browser or download the latest version of' + 
                        ...
                        jQuery('#bloomerangForm22137856').after(html22137856);
                                            ...
                                            Bloomerang.Util.load('https://core.spreedly.com/iframe/express-2.min.js', 
                                                ...
                                                function() {
                                                    ...
                                                    Bloomerang.initSpreedly = function() {
                                                        SpreedlyExpress.init('OqOMv1ksjPtXEYHtCYsVXzEpCbR', { 'company_name': 'Extollo International' });
                                                    };
                       ...
                       window.captchaLoadCallback = function() {
                        ...
                        Bloomerang.Util.load('https://www.google.com/recaptcha/api.js?onload=captchaLoadCallback&render=explicit',
                            ...
                            function() {
                                ...
                                jQuery('form.donation-form').data('captcha-id', grecaptcha.render('captcha22137856', { 'sitekey' : '6Ld53LoUAAAAAHl19Q9v7UiR3M31xK2yOYztzX_y' }));
                            },
                            true,
                            true);
                    Bloomerang.transactionFee = 0.29; Bloomerang.transactionFeeRate = 0.0249; Bloomerang.transactionFeeEft = 0.80
                    Bloomerang.useKey('pub_8d47eac4-774a-11e9-9f3d-0aa640fb8062');
        ...
        Bloomerang.Api.OnSuccess = Bloomerang.Widget.Donation.OnSuccess = function (response) {
            ...
            formContainer.show();
            formContainer.html(successHtml22137856);
              ...
              jQuery(e).toggle();
                ...
                var startBloomerangLoad = function() {
                    if (window.bloomerangLoadStarted == undefined) {
                        ...
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidation(function() { insertForm22137856(); })});
                    }
                    else {
                        waitForBloomerangLoad(function() { Bloomerang.Util.requireJQueryValidation(function() { insertForm22137856(); })});
                    }
